...
interface ReportModalProps {
  ...
  onClose: () => void;
  onSubmit: (targetType: "post" | "comment", targetId: string, reason: string) => Promise<void>;
}
...
export function ReportModal({
  ...
  const canSubmit =
    !!targetId &&
    !!selected &&
    (selected !== "Lainnya" || customReason.trim().length > 0) &&
    !submitting;
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: 12, color: "#64748b", lineHeight: 18 }}>
            Pilih alasan pelaporan. Jika 10 orang melaporkan, postingan otomatis disembunyikan untuk
            direview admin.
          </Text>
          ...
          <View style={{ flexDirection: "row", gap: 8, marginTop: 4 }}>
            ...
            >
              <Text style={{ fontSize: 13, fontWeight: "bold", color: "#64748b" }}>Batal</Text>
            </TouchableOpacity>
            <TouchableOpacity
