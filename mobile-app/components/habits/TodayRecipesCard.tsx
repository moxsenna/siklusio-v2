    ...
    >
      <View style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 12 }}>
        ...
        <View style={{ flex: 1, gap: 4 }}>
          <Text style={{ fontSize: 11, color: '#4d7c0f', fontWeight: '800', textTransform: 'uppercase' }}>
            Resep Hari Ini
          </Text>
          ...
          <Text style={{ fontSize: 12, color: '#64748b', lineHeight: 18 }}>
            Dapatkan 2 resep simpel + daftar belanja kecil yang cocok dengan fase {currentPhase || 'siklusmu'}.
          </Text>
        </View>
      </View>
