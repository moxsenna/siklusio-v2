...
export function AffirmationCard({ displayPhase }: { displayPhase: string }) {
  ...
  return (
    <View className="bg-pink-50 rounded-[24px] p-[20px] shadow-sm border border-pink-100 flex-row gap-[16px]">
      <View className="w-[40px] h-[40px] bg-pink-100 rounded-full items-center justify-center">
