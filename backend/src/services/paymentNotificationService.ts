...
export type PaymentNotificationSession = {
  id: string;
  email?: string | null;
...
export type PaymentNotificationPending = {
  id: string;
  email: string;
  name?: string | null;
  whatsapp?: string | null;
...
export async function sendWebhookPurchaseMetaCapi(params: {
  ...
  session: PaymentNotificationSession | null;
  email: string;
  pending: PaymentNotificationPending;
...
export async function retryPaidSessionPurchaseMetaCapi(params: {
  c: BindingsContext;
  supabaseAdmin: SupabaseClient;
  session: PaymentNotificationSession;
  mayarTransactionId: string | null;
}) {
