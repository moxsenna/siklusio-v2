  ...
  public: {
    Tables: {
      ...
      admin_crm_leads: {
        Row: {
          ...
          lead_status: Database["public"]["Enums"]["admin_crm_lead_status"]
          manual_payment_reference: string | null
          mayar_payment_id: string | null
          mayar_transaction_id: string | null
          name: string | null
          next_followup_at: string | null
          payment_status: Database["public"]["Enums"]["admin_crm_payment_status"]
      ...
      admin_crm_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_crm_notes_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "admin_crm_leads"
            referencedColumns: ["id"]
          },
        ]
      }
      admin_crm_payment_overrides: {
        Row: {
          ...
          lead_id: string
          new_payment_status: Database["public"]["Enums"]["admin_crm_payment_status"]
          old_payment_status:
            | Database["public"]["Enums"]["admin_crm_payment_status"]
            | null
          reason: string
        ...
        Relationships: [
          {
            foreignKeyName: "admin_crm_payment_overrides_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "admin_crm_leads"
            referencedColumns: ["id"]
      ...
      whatsapp_autoresponder_logs: {
        Row: {
          ...
          event_key: Database["public"]["Enums"]["whatsapp_autoresponder_event"]
          id: string
          idempotency_key: string
          metadata: Json
          provider: string
          ...
          sent_at: string | null
          status: Database["public"]["Enums"]["whatsapp_autoresponder_log_status"]
          updated_at: string
        }
        Insert: {
          created_at?: string
    ...
    Functions: {
      admin_crm_upsert_lead: {
        Args: {
          ...
          p_currency?: string
          p_email?: string
          p_lead_status?: Database["public"]["Enums"]["admin_crm_lead_status"]
          p_mayar_payment_id?: string
          p_mayar_transaction_id?: string
          p_name?: string
          p_payment_status?: Database["public"]["Enums"]["admin_crm_payment_status"]
          p_pending_registration_id?: string
    ...
    Enums: {
      ...
      admin_crm_payment_status:
        ...
        | "cancelled"
        | "refunded"
      whatsapp_autoresponder_event:
        | "registration_completed"
        | "payment_completed"
      whatsapp_autoresponder_log_status:
        | "pending"
        | "sent"
        | "failed"
        | "skipped"
