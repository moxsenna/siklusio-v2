...
export function ComposerModal({ visible, onClose, onSubmit, cooldownLeft = 0 }: ComposerModalProps) {
  ...
  const canSubmit =
    content.trim().length > 0 && !isOverLimit && !submitting && !isCoolingDown;
    ...
    >
      <View
        style={{
          flex: 1,
          backgroundColor:
            Platform.OS === 'web' ? 'rgba(20, 20, 20, 0.4)' : '#fcf8fa',
          alignItems: 'center',
      ...
      >
        ...
        >
          <TouchableOpacity onPress={handleClose} disabled={submitting}>
            <Text style={{ fontSize: 14, color: '#64748b', fontWeight: 'bold' }}>
              Batal
            </Text>
          </TouchableOpacity>
