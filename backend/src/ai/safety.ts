...
export const HARD_FORBIDDEN = ["pasti hamil", "dijamin", "tidak perlu dokter"];

export const CONTEXTUAL_FORBIDDEN = ["dosis", "obat hormon"];

export const ACTION_TRIGGERS = ["minum", "gunakan", "konsumsi", "atur", "resep", "ambil"];
