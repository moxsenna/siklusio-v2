  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 40 }} style={{ flex: 1 }}>
        ...
        <CycleGuideCard preview={cycleGuidePreview} onOpen={() => setShowCycleGuide(true)} />
        ...
        {selectedDate &&
          (() => {
            ...
            if (isPeriod) {
              ...
              phaseDesc =
                "Fase: Hari Ovulasi (Peluang hamil tertinggi) - Promil aktif sangat relevan";
              ...
              <View className="bg-surface p-6 mt-6 rounded-[32px] border border-outline-variant shadow-sm flex-col gap-4">
                <View className="flex-row items-center gap-4">
                  ...
                  <View className="flex-1">
                    ...
                    <Text className={`text-sm mt-0.5 leading-normal ${phaseColor}`}>
                      {phaseDesc}
                    </Text>
                  </View>
                </View>
                ...
                >
                  ...
                  >
                    {isLoggedPeriod
                      ? "Haid Tercatat (Ketuk untuk Hapus)"
                      : "Tandai Sedang Menstruasi"}
                  </Text>
                </TouchableOpacity>
              </View>
            );
