    ...
    <View style={{ gap: 20 }}>
      ...
      <View style={{ flexDirection: "row", gap: 16, flexWrap: "wrap" }}>
        ...
        >
          ...
          <Text style={{ fontSize: 24, fontWeight: "900", color: "#1e1b20", marginTop: 8 }}>
        ...
        >
          ...
          <Text style={{ fontSize: 24, fontWeight: "900", color: "#eab308", marginTop: 8 }}>
        ...
        >
          ...
          <Text style={{ fontSize: 24, fontWeight: "900", color: "#10b981", marginTop: 8 }}>
      ...
      {/* Sub-Tabs */}
      <View
        style={{ flexDirection: "row", backgroundColor: "#f1f5f9", borderRadius: 16, padding: 4 }}
      >
        <TouchableOpacity
          ...
          style={{
            ...
            alignItems: "center",
            borderRadius: 12,
            backgroundColor: activeSubTab === "list" ? "#fff" : "transparent",
            shadowColor: activeSubTab === "list" ? "#000" : "transparent",
            shadowOpacity: 0.05,
            shadowRadius: 5,
            elevation: activeSubTab === "list" ? 2 : 0,
          }}
        >
          <Text
            style={{
              fontSize: 13,
              fontWeight: "bold",
              color: activeSubTab === "list" ? "#1e1b20" : "#64748b",
            }}
          >
            Daftar Afiliasi
          </Text>
        ...
        <TouchableOpacity
          ...
          style={{
            ...
            alignItems: "center",
            borderRadius: 12,
            backgroundColor: activeSubTab === "conversions" ? "#fff" : "transparent",
            shadowColor: activeSubTab === "conversions" ? "#000" : "transparent",
            shadowOpacity: 0.05,
            shadowRadius: 5,
            elevation: activeSubTab === "conversions" ? 2 : 0,
          }}
        >
          <Text
            style={{
              fontSize: 13,
              fontWeight: "bold",
              color: activeSubTab === "conversions" ? "#1e1b20" : "#64748b",
            }}
          >
            Riwayat Konversi
          </Text>
      ...
      {activeSubTab === "list" ? (
        <View style={{ gap: 24 }}>
          ...
          >
            ...
            <View style={{ flexDirection: "row", gap: 16, flexWrap: "wrap" }}>
              ...
              <TextInput
                ...
                onChangeText={(t) =>
                  setNewAffiliate((p) => ({ ...p, code: t.toUpperCase().replace(/\s/g, "") }))
                }
              ...
              >
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    backgroundColor:
                      newAffiliate.commission_type === "percentage" ? "#ec4899" : "transparent",
                  }}
                >
                  <Text
                    style={{
                      fontSize: 12,
                      fontWeight: "bold",
                      color: newAffiliate.commission_type === "percentage" ? "#fff" : "#64748b",
                    }}
                  >
                    Persen (%)
                  </Text>
                ...
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    justifyContent: "center",
                    backgroundColor:
                      newAffiliate.commission_type === "nominal" ? "#ec4899" : "transparent",
                  }}
                >
                  <Text
                    style={{
                      fontSize: 12,
                      fontWeight: "bold",
                      color: newAffiliate.commission_type === "nominal" ? "#fff" : "#64748b",
                    }}
                  >
                    Nominal (Rp)
                  </Text>
            ...
            <TouchableOpacity
              onPress={() =>
                setNewAffiliate((p) => ({ ...p, autoCreateCoupon: !p.autoCreateCoupon }))
              }
            ...
            >
              <View
                style={{
                  ...
                  borderRadius: 6,
                  borderWidth: 2,
                  borderColor: newAffiliate.autoCreateCoupon ? "#ec4899" : "#cbd5e1",
                  backgroundColor: newAffiliate.autoCreateCoupon ? "#ec4899" : "#fff",
                  alignItems: "center",
                  justifyContent: "center",
                }}
              >
                {newAffiliate.autoCreateCoupon && (
                  <FontAwesome name="check" size={14} color="#fff" />
                )}
              </View>
              <Text style={{ fontSize: 13, color: "#475569", fontWeight: "500" }}>
                Buat kupon diskon otomatis dengan kode ini
              </Text>
            </TouchableOpacity>
          ...
          {/* List Affiliates */}
          <Text style={{ fontSize: 18, fontWeight: "bold", color: "#1e1b20" }}>
            Daftar Afiliasi ({affiliates.length})
          </Text>
          {loading ? (
                ...
                >
                  ...
                  >
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                      ...
                      <TouchableOpacity onPress={() => handleDelete(aff.id)} style={{ padding: 8 }}>
        ...
        <View style={{ gap: 24 }}>
          {/* Conversions List */}
          <Text style={{ fontSize: 18, fontWeight: "bold", color: "#1e1b20" }}>
            Riwayat Konversi ({conversions.length})
          </Text>
          {conversionsLoading ? (
            <ActivityIndicator size="large" color="#ec4899" />
          ) : (
            <View style={{ gap: 12 }}>
              {conversions.map((conv) => (
                ...
                >
                  ...
                  <View
                    style={{ backgroundColor: "#f8fafc", padding: 12, borderRadius: 12, gap: 4 }}
                  >
